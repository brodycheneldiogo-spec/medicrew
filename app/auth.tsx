...
async function recordLegal(c:NonNullable<typeof supabase>,_profileId:string){const{error}=await c.rpc('accept_current_legal_terms');if(error)throw error}
...
const s=StyleSheet.create({safe:{flex:1,backgroundColor:colors.paper},container:{padding:22,paddingBottom:45},top:{flexDirection:'row',alignItems:'center',justifyContent:'space-between',marginBottom:10},back:{fontSize:15,fontWeight:'800',color:colors.ink},progress:{fontSize:9,fontWeight:'900',letterSpacing:1.2,color:colors.greenDark,marginTop:16},title:{fontSize:34,fontWeight:'900',color:colors.ink,marginTop:7,lineHeight:39},sub:{fontSize:13,lineHeight:20,color:colors.muted,marginTop:8},form:{marginTop:25},field:{marginBottom:15},label:{fontSize:11,fontWeight:'800',color:colors.ink,marginBottom:7},input:{height:52,borderWidth:1,borderColor:colors.line,borderRadius:radii.md,paddingHorizontal:14,fontSize:15,color:colors.ink,backgroundColor:colors.white},password:{height:52,borderWidth:1,borderColor:colors.line,borderRadius:radii.md,backgroundColor:colors.white,flexDirection:'row',alignItems:'center'},passwordInput:{flex:1,paddingHorizontal:14,fontSize:15,color:colors.ink},eye:{fontSize:11,fontWeight:'800',color:colors.greenDark,paddingHorizontal:14},rules:{fontSize:10.5,color:colors.muted,marginTop:7,marginBottom:10},button:{height:54,borderRadius:radii.md,alignItems:'center',justifyContent:'center',marginTop:12},buttonText:{fontSize:14,fontWeight:'900',color:colors.white},google:{height:54,borderWidth:1,borderColor:colors.line,borderRadius:radii.md,backgroundColor:colors.white,flexDirection:'row',alignItems:'center',justifyContent:'center',gap:10,marginTop:10},googleText:{fontSize:13,fontWeight:'800',color:'#202124'},switch:{paddingVertical:14,alignItems:'center'},switchText:{fontSize:12,fontWeight:'800',color:colors.greenDark},legalNotice:{paddingVertical:13,paddingHorizontal:4,alignItems:'center'},legalText:{fontSize:10.5,lineHeight:16,color:colors.muted,textAlign:'center'},legalLink:{marginTop:5,fontSize:11,fontWeight:'900',color:colors.greenDark}});
