...
export default function Skills(){
  ...
  const save=async()=>{
    ...
    const skills=Object.entries(selected).map(([slug,level])=>({slug,level,years:Math.max(0, Number(years[slug]||0))}));
