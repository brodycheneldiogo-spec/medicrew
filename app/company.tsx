    ...
    <SafeAreaView style={styles.safe}>
      <ScrollView contentContainerStyle={styles.container}>
        <View style={styles.header}>
          ...
          <TouchableOpacity onPress={() => router.push('/notifications')} style={styles.bell}><Text style={styles.bellText}>♧</Text></TouchableOpacity>
        </View>
        ...
        <View style={styles.sectionHead}><Text style={styles.sectionTitle}>Open missions</Text><TouchableOpacity onPress={() => router.push('/company-mission')}><Text style={styles.link}>See all</Text></TouchableOpacity></View>
