...
alter table public.missions add constraint missions_compensation_currency_check check (compensation_currency ~ '^[A-Z]{3}$');
...
comment on column public.missions.compensation_currency is 'Original contractual currency for professional compensation.';
