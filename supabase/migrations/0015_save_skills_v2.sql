-- Skills persistence v2.
-- Keep the legacy replace_my_skills(jsonb) signature untouched; expose a new
-- JSON-returning function so the mobile client can verify the write safely.
